...
class SAS7BDATReader(ReaderBase, abc.Iterator):
    ...
    def _get_properties(self) -> None:
        ...
        self._cached_page = Page(self, self._cached_page.data, self.is_little_endian())
        ...
        self._cached_page = Page(
            self, self._cached_page.data + buf, self.is_little_endian()
        )
    ...
    def _parse_metadata(self) -> None:
        ...
        while not done:
            self._cached_page = Page(
                self, self._path_or_buf.read(self._page_length), self.is_little_endian()
            )
    ...
    def _read_page_header(self):
        ...
        self._current_page_type = self._cached_page.read_int(tx, const.page_type_length)
